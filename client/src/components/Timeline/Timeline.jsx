...
const CustomizableTimeline = ({
        ...
        return (
            <div
                className={`flex justify-between ${
                    orientation === "vertical" ? "my-6 mx-5" : "mx-6 my-5"
                }`}
            >
                <button
                    onClick={onPrevious}
    ...
    const renderActiveStepContent = () => {
        ...
        return (
            <div
                className={`mt-6 ${config.padding} bg-white border border-gray-200 rounded-lg shadow-sm`}
            >
                {renderStepContent ? (
                    ...
                    <div>
                        <h3
                            className={`${config.font} font-semibold text-gray-900 mb-2`}
                        >
                            {activeStep.title}
                        </h3>
                        {activeStep.description && (
                            <p
                                className={`${config.font} text-gray-600 leading-relaxed`}
                            >
                                {activeStep.description}
                            </p>
                        )}
