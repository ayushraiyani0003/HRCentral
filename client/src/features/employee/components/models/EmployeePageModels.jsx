...
import { CustomModal, FileUpload, CustomizableTimeline, CustomTextInput, ModernDateRangePicker, CustomDropdown } from "../../../../components";

function EmployeePageModels({
  ...
  const handleStepChange = (stepIndex, step) => {
    ...
    // You can add additional logic here when step changes
  };
  ...
  const steps = [
    ...
    },
    {
      ...
      fields: [
        { name: "department", label: "Department", required: true, type: "dropdown", options: [
        ...
        { name: "employeeId", label: "Employee ID", required: true, type: "text" },
    ...
    },
    {
      ...
      fields: [
        { name: "insurancePlan", label: "Insurance Plan", required: true, type: "dropdown", options: [
          { value: "basic", label: "Basic Plan" },
          { value: "premium", label: "Premium Plan" },
          { value: "family", label: "Family Plan" }
        ]},
        { name: "bankAccount", label: "Bank Account Details", required: true, type: "text" },
        { name: "taxNumber", label: "Tax ID Number", required: true, type: "text" },
        { name: "emergencyContact", label: "Emergency Contact Name", required: true, type: "text" },
        { name: "emergencyPhone", label: "Emergency Contact Phone", required: true, type: "tel" },
      ],
    },
  ];
              ...
              <div key={field.name} className="form-group">
                {field.type === 'textarea' ? (
                  ...
                  <CustomDropdown
                    ...
                    value={employeeFormData[field.name] ? [employeeFormData[field.name]] : []}
                    onChange={(selectedValues) => handleInputChange(field.name, selectedValues[0] || '')}
                  ...
                  <ModernDateRangePicker
                    ...
                    initialStartDate={employeeFormData[field.name] ? new Date(employeeFormData[field.name]) : null}
        ...
        {isCompleted && !isActive && (
          <div className="bg-green-50 border border-green-200 rounded-md p-4">
            ...
            <div className="mt-2 text-sm text-green-700">
              {step.fields.filter(f => employeeFormData[f.name]).length} of {step.fields.length} fields filled
            </div>
          </div>
        )}
...
export default EmployeePageModels;