...
module.exports = (sequelize, DataTypes) => {
  const ManPowerRequisition = sequelize.define(
    "ManPowerRequisition",
    {
      ...
      //reference from company structure table
      ...
      //reference from designation table
      ...
      requirement_category: {
        ...
        allowNull: false,
        comment: "Category of employment: permanent, technical, or fixed term",
      },
      requirement_type: {
        type: DataTypes.ENUM(
          "replacement",
      ...
      // Reference from employee table
      requested_by_id: {
        type: DataTypes.UUID,
        allowNull: true,
        comment: "Foreign key reference to Employee who requested the manpower",
      },
      // Reference from employee table
      agreed_by_id: {
        type: DataTypes.UUID,
      ...
      // Reference from Management table
      approved_by_id: {
        type: DataTypes.UUID,
        allowNull: true,
        defaultValue: null,
        comment: "Foreign key reference to Management who approved the request",
      },
      ...
      approval_status: {
        type: DataTypes.ENUM("selected", "pending", "rejected", "OnHold"),
        allowNull: false,
        defaultValue: "pending",
